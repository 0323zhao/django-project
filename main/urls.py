...
for i in os.listdir(mainDir):
    if i not in excludeList and i[-5:] == "_v.py":
        ...
        if tableName.lower()=="blogcomment":
            urlpatterns.extend(
                [
                    path(r'{}/value/<xColumnName>/<yColumnName>/<timeStatType>'.format(tableName.lower()),
                         eval("{}_v.{}_value".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "yonghu":
            urlpatterns.extend(
                [
                    ...
                    path(r'{}/sendsms/login'.format(tableName.lower()),
                         eval("{}_v.{}_sendsms".format(tableName.capitalize(), tableName.lower()))),
                    path(r'{}/sms/login'.format(tableName.lower()),
                         eval("{}_v.{}_sms_login".format(tableName.capitalize(), tableName.lower()))),
                ]
            )
#预测
        if tableName.lower() == "bloginfoforecast":
            urlpatterns.extend(
                       [
        ...
        if tableName.lower()=="pinglunfenxi":
            urlpatterns.extend(
                [
                    path(r'{}/value/<xColumnName>/<yColumnName>/<timeStatType>'.format(tableName.lower()),
                         eval("{}_v.{}_value".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "pinglunfenxi":
            urlpatterns.extend(
                [
                    path(r'{}/baidu/sa'.format(tableName.lower()),
                         eval("{}_v.{}_baidu_sa".format(tableName.capitalize(), tableName.lower())))
                ]
            )
        if tableName.lower() == "pinglunfenxi":
            urlpatterns.extend(
        ...
        if tableName.lower() == "pinglunfenxi":
            urlpatterns.extend([
                # ... 原有路由 ...
                path(r'{}/batchAnalyze'.format(tableName.lower()),
                     eval("{}_v.{}_batch_analyze".format(tableName.capitalize(), tableName.lower()))),
            ])
        if tableName.lower() == "pinglunfenxi":
            urlpatterns.extend([
                # ... 原有路由 ...
                path(r'{}/batchAnalyze'.format(tableName.lower()),
                     eval("{}_v.{}_batch_analyze".format(tableName.capitalize(), tableName.lower()))),
                path(r'{}/stopBatchAnalyze'.format(tableName.lower()),
                     eval("{}_v.{}_stop_batch_analyze".format(tableName.capitalize(), tableName.lower()))),
            ])
        ...
        if tableName.lower() == "discussbloginfo":
            urlpatterns.extend(
                [
                    path(r'{}/security'.format(tableName.lower()),
                         eval("{}_v.{}_security".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "discussblogcomment":
            urlpatterns.extend(
                [
                    path(r'{}/security'.format(tableName.lower()),
                         eval("{}_v.{}_security".format(tableName.capitalize(), tableName.lower()))),
