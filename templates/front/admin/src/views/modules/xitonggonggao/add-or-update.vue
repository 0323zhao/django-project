		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="公告分类" prop="gonggaofenlei" >
					<el-input v-model="ruleForm.gonggaofenlei" placeholder="公告分类" clearable  :readonly="ro.gonggaofenlei"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="公告分类" prop="gonggaofenlei" >
					<el-input v-model="ruleForm.gonggaofenlei" placeholder="公告分类" readonly></el-input>
				</el-form-item>
			...
			async info(id) {
				await this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.gonggaoneirong = this.ruleForm.gonggaoneirong.replace(reg,'../../../djangop8gh5erc/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
