				...
				<div class="center-content-view" v-show="activeName=='个人中心'">
					<el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="180px">
						...
						<el-form-item class="center-item" v-if="userTableName=='yonghu'" label="手机号" prop="mobile">
							<el-input v-model="sessionForm.mobile" placeholder="手机号" :disabled="ro.mobile"></el-input>
						</el-form-item>
...
<style rel="stylesheet/scss" lang="scss" scoped>
	.center-preview {
		...
		.center-box {
			...
			.center-tab-view {
				padding: 13px 20px 0;
				background: url("http://codegen.caihongy.cn/20251208/0c7bbba3fe0e49c29e6353af4ca598ae.png") center top no-repeat;
				display: inline-block;
				width: 100%;
				min-height: 66px;
				border-color: #fff;
