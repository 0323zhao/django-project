	...
	<div class="main-containers">
		<div class="body-containers">
			<div class="top-container">
				<!-- info -->
				<div class="top_title">
					<span @click="goMenu('/index/home')">基于spank的社交媒体情感分析系统的设计与实现</span>
				</div>
	...
	.main-containers {
		.body-containers {
			...
			.top-container {
				...
				top: 0;
				left: 0;
				background: url(http://codegen.caihongy.cn/20251208/0c7bbba3fe0e49c29e6353af4ca598ae.png)no-repeat top center;
				width: 100%;
			...
			.banner-preview {
				...
				.swiper-button-next {
					...
					.icon {
						...
						padding: 0 16px;
						color: #fff;
						background: linear-gradient( 180deg, #1F313B 0%, #2B444A 100%);
						display: inline-block;
						width: auto;
						font-size: 20px;
						line-height: 48px;
