		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<div class="list-btn-box">
					...
					<el-button class="list-add-btn" v-if="btnAuth('bloginfoforecast','新增')" type="primary" @click="add('/index/bloginfoforecastAdd')">
						<span class="icon iconfont icon-tianjia7"></span>
						新增
					</el-button>
					<el-button v-if="btnAuth('bloginfoforecast','预测')" class="list-forecastImg-btn" type="success" @click="forecastImgClick()">
				...
				<el-table class="tables" :stripe='false'
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="table-btn5" type="success" @click.native="chapterClick(scope.row)" v-if="btnAuth('bloginfoforecast','章节管理')">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				this.$http.get(`bloginfoforecast/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(async res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/bloginfoforecastDetail', query: params});
			},
			...
			forecastImgClick(){
				...
				this.$http.get('bloginfoforecast/forecastimgs').then(res=>{
